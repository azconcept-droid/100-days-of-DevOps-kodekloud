...
d. Create a database named kodekloud_db4 and create a database user named kodekloud_top identified as password TmPcZjtRQx. Further make sure this newly created user is able to perform all operation on the database you created.
